			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="top-navbar-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="1000">
								<i class="fa fa-sign-in"></i><br>Зарегистрироваться/Войти <span class="caret"></span>
							</a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="pricing-tables.php">Sign Up</a></li>
  							<li><a href="pricing-tables.php">Sign I n</a></li>
							</ul>
						</li>
					</ul>
				</div>
	            ...
	            <div class="row">
	            	<div class="col-sm-3">
		                <div class="service wow fadeInUp">
		                    ...
		                    <a class="big-link-1" href="components.php">Read more</a>
		                </div>
					</div>
					<div class="col-sm-3">
	            	...
	            	<div class="col-sm-3">
		                <div class="work wow fadeInUp">
		                    ...
		                    <div class="work-bottom">
		                        ...
		                        <a class="big-link-2" href="styles.php"><i class="fa fa-link"></i></a>
		                    </div>
		                </div>
	                </div>
	                <div class="col-sm-3">
